...
return {
setters: [dep => dependencies.set('@beyond-js/kernel@0.1.1/bundle', dep), dep => dependencies.set('react@18.2.0', dep), dep => dependencies.set('scheduler@0.23.0', dep), dep => dependencies.set('react-dom@18.2.0', dep), dep => dependencies.set('react-dom@18.2.0/client', dep), dep => dependencies.set('@beyond-js/kernel@0.1.1/core', dep), dep => dependencies.set('@beyond-js/widgets@0.1.0/render', dep), dep => dependencies.set('@beyond-js/kernel@0.1.1/styles', dep), dep => dependencies.set('@beyond-js/widgets@0.1.0/controller', dep), dep => dependencies.set('@beyond-js/react-widgets@18.20.1/base', dep), dep => dependencies.set('@beyond-js/kernel@0.1.1/routing', dep), dep => dependencies.set('@beyond-js/widgets@0.1.0/routing', dep)],
execute: function() {
